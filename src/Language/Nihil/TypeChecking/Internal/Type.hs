...
module Language.Nihil.TypeChecking.Internal.Type where
...
data Type
    ...
    | TInt            -- ^ The integer type (which is an alias defined in 'Nihil.Prelude.defaultTypeDefContext')
    | TFloat          -- ^ The float type (also an alias defined in 'Nihil.Prelude.defaultTypeDefContext')
    | TChar           -- ^ The char type (also an alias defined in 'Nihil.Prelude.defaultTypeDefContext')
