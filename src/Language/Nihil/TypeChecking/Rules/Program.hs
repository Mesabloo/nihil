...
module Language.Nihil.TypeChecking.Rules.Program where

import Language.Nihil.Syntax.Internal.Parsing.Located
import qualified Language.Nihil.Syntax.Internal.Desugaring.CoreAST as TP
import Language.Nihil.TypeChecking.TypeChecker (Check, TIError)
import Language.Nihil.TypeChecking.Internal.Type
import Language.Nihil.TypeChecking.Internal.Substitution.Types
import Language.Nihil.TypeChecking.Rules.Types.Infer
import Language.Nihil.TypeChecking.Internal.Environment
import Language.Nihil.TypeChecking.Internal.Constraint
import Language.Nihil.TypeChecking.Internal.Errors.BindLack
import Language.Nihil.TypeChecking.Internal.Errors.RedefinedVariable
import Language.Nihil.TypeChecking.Internal.Errors.RedeclaredVariable
import Language.Nihil.TypeChecking.Internal.Errors.MistypedGADT
import Language.Nihil.TypeChecking.Internal.Substitution
import Language.Nihil.TypeChecking.Solver.TypeHoleSolver
import Language.Nihil.TypeChecking.Solver.TypeSolver
import qualified Language.Nihil.TypeChecking.Rules.Kinds.Infer as Kind
import qualified Language.Nihil.TypeChecking.KindChecker as Kind
import Language.Nihil.TypeChecking.Solver.KindSolver (runKindSolver)
import Language.Nihil.TypeChecking (runKI)
