...
module Language.Nihil.TypeChecking.Rules.Types.Infer where

import Language.Nihil.TypeChecking.TypeChecker (TI, count, TIError, TypeState(..))
...
import Language.Nihil.Syntax.Internal.Desugaring.CoreAST hiding (Type(..), Scheme(..), CustomType(..))
import qualified Language.Nihil.Syntax.Internal.Desugaring.CoreAST as TP (Type(..), CustomType(..), Scheme(..))
import Language.Nihil.TypeChecking.Internal.Environment
import Language.Nihil.TypeChecking.Internal.Errors.BindLack
import Language.Nihil.TypeChecking.Internal.Errors.UnboundVariable
import Language.Nihil.TypeChecking.Internal.Substitution.Types
import Language.Nihil.TypeChecking.Internal.Substitution
import Language.Nihil.TypeChecking.Internal.Errors.MissingConstructorArguments
