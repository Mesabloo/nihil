...
module Language.Nihil.TypeChecking.Rules.Types.Unify where

import Language.Nihil.TypeChecking.Internal.Type
import Language.Nihil.TypeChecking.Internal.Substitution.Types
import Language.Nihil.TypeChecking.TypeChecker (Solve)
import Language.Nihil.TypeChecking.Internal.Errors.Unification
import Language.Nihil.TypeChecking.Internal.Errors.InfiniteType
import Language.Nihil.TypeChecking.Internal.Errors.TypeHole
import Language.Nihil.TypeChecking.Internal.Unification
import Language.Nihil.TypeChecking.Internal.Environment (typeDefCtx)
