...
module Language.Nihil.Syntax.Internal.Lexing.Helpers
(lexeme, getPositionInSource, space') where

import Language.Nihil.Syntax.Lexer (Lexer)
import Language.Nihil.Syntax.Internal.Lexing.SourceSpan (SourceSpan(..))
...
-- It most likely returns a 'Language.Nihil.Lexing.Lexeme', but not necessarily.
