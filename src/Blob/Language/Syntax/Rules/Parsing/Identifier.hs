...
module Blob.Language.Syntax.Rules.Parsing.Identifier where

import Blob.Language.Syntax.Parser (Parser)
import Blob.Language.Syntax.Tokens.Lexeme (Lexeme(LUpIdentifier, LLowIdentifier), isLowIdentifier, isUpIdentifier)
